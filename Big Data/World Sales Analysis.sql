...
--3. Print the dataframe schema in a tree format
%spark2
...
--12.	From the “Salesview” view, show the Total Profit as Profit, the Total Revenue as Revenue and the Total Cost as Cost from “Salesview” group by Region 
